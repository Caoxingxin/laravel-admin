            ...
            <div class="row cl">
                <div class="col-md-24">
                    <ul class="nav navbar-nav" style="font-size: 30px">
                        <li class="active"><a href="{{ url('/head') }}" class="btn btn-default" style="margin: 10px;width: 90px">总部</a></li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle btn btn-default" data-toggle="dropdown" style="margin: 10px;width: 90px">
                                学校
                                <b class="caret"></b>
                            </a>
